        ...
        <form action="{{route('facturas.store')}}" method="POST">
            ...
            <div class="form-group{{ $errors->has('fecha_factura') ? ' has-error' : '' }}">
                <div class="form-group">
                    ...
                    <input type="text" value="{{old('fecha_factura')}}" name="fecha_factura" required class="form-control" placeholder="Ingresefecha de la factura">
            ...
            <div class="form-group{{ $errors->has('nombre_producto') ? ' has-error' : '' }}">
                <div class="form-group">
                    ...
                    <input type="text" value="{{old('nombre_producto')}}" name="nombre_producto" required class="form-control" placeholder="Ingrese nombre del producto">
